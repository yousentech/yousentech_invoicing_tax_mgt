    ...
    def _get_allow_modify_product_tax_in_invoice(self):
        for rec in self:
            rec.allow_modify_product_tax_in_invoice = self.user_has_groups(
                'custom_sada_alhadia_13.group_allow_modify_product_tax_in_invoice')

    def _default_allow_modify_product_tax_in_invoice(self):
        return self.user_has_groups('custom_sada_alhadia_13.group_allow_modify_product_tax_in_invoice')
    # *******************************************************************************************************
